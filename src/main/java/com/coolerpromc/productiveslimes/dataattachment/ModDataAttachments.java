...
public class ModDataAttachments {
    ...
    public static final Supplier<AttachmentType<Boolean>> IS_FIRST_TIME_LOGIN = ATTACHMENT_TYPES.register("is_first_time_login", () -> AttachmentType.builder(() -> true).serialize(Codec.BOOL).build());
