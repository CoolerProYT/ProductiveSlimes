...
public class ModFluids {
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_DIRT_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_dirt_block",
            properties -> new LiquidBlock(ModFluids.SOURCE_MOLTEN_DIRT.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_dirt_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_STONE_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_stone_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_STONE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_stone_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_COPPER_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_copper_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_COPPER.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_copper_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_IRON_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_iron_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_IRON.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_iron_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_GOLD_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_gold_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_GOLD.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_gold_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_DIAMOND_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_diamond_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_DIAMOND.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_diamond_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_NETHERITE_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_netherite_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_NETHERITE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_netherite_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_LAPIS_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_lapis_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_LAPIS.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_lapis_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_REDSTONE_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_redstone_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_REDSTONE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_redstone_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_OAK_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_oak_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_OAK.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_oak_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_SAND_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_sand_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_SAND.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_sand_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_ANDESITE_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_andesite_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_ANDESITE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_andesite_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_SNOW_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_snow_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_SNOW.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_snow_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_ICE_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_ice_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_ICE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_ice_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_MUD_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_mud_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_MUD.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_mud_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_CLAY_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_clay_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_CLAY.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_clay_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_RED_SAND_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_red_sand_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_RED_SAND.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_red_sand_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_MOSS_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_moss_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_MOSS.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_moss_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_DEEPSLATE_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_deepslate_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_DEEPSLATE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_deepslate_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_GRANITE_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_granite_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_GRANITE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_granite_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_DIORITE_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_diorite_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_DIORITE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_diorite_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_CALCITE_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_calcite_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_CALCITE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_calcite_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_TUFF_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_tuff_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_TUFF.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_tuff_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_DRIPSTONE_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_dripstone_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_DRIPSTONE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_dripstone_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_PRISMARINE_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_prismarine_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_PRISMARINE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_prismarine_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_MAGMA_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_magma_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_MAGMA.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_magma_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_OBSIDIAN_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_obsidian_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_OBSIDIAN.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_obsidian_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_NETHERRACK_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_netherrack_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_NETHERRACK.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_netherrack_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_SOUL_SAND_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_soul_sand_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_SOUL_SAND.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_soul_sand_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_SOUL_SOIL_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_soul_soil_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_SOUL_SOIL.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_soul_soil_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_BLACKSTONE_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_blackstone_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_BLACKSTONE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_blackstone_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_BASALT_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_basalt_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_BASALT.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_basalt_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_ENDSTONE_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_endstone_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_ENDSTONE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_endstone_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_QUARTZ_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_quartz_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_QUARTZ.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_quartz_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_GLOWSTONE_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_glowstone_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_GLOWSTONE.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_glowstone_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_AMETHYST_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_amethyst_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_AMETHYST.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_amethyst_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_BROWN_MUSHROOM_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_brown_mushroom_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_BROWN_MUSHROOM.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_brown_mushroom_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_RED_MUSHROOM_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_red_mushroom_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_RED_MUSHROOM.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_red_mushroom_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_CACTUS_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_cactus_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_CACTUS.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_cactus_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_COAL_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_coal_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_COAL.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_coal_block"))), BlockBehaviour.Properties.of());
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_GRAVEL_BLOCK = ModBlocks.BLOCKS.registerBlock("molten_gravel_block",
            properties-> new LiquidBlock(ModFluids.SOURCE_MOLTEN_GRAVEL.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable().setId(createKey("molten_gravel_block"))), BlockBehaviour.Properties.of());
