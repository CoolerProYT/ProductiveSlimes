    ...
    public static void registerTierFluids() {
        for (Tier tier : Tier.values()){
            ...
            ModFluidResources.FluidStuff fluidStuff = ModFluidResources.register(() -> ModFluidResources.addFluid(
                    ...
                    (supplier, properties) -> new LiquidBlock(supplier.get(), properties.setId(ResourceKey.create(Registries.BLOCK, Identifier.fromNamespaceAndPath(ProductiveSlimes.MODID, "molten_" + tiers.name() + "_block")))),
