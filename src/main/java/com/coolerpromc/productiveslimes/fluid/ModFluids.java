...
public class ModFluids {
    ...
    public static final DeferredBlock<LiquidBlock> MOLTEN_OAK_LEAVES_BLOCK = ModBlocks.BLOCKS.register("molten_oak_leaves_block",
            () -> new LiquidBlock(ModFluids.SOURCE_MOLTEN_OAK_LEAVES.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).noLootTable()));
