    ...
    public static void onVillagerTrades(VillagerTradesEvent event) {
        if (event.getType() == ModVillagers.SCIENTIST){
            ...
            trades.get(1).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemCost(ModTiers.getSlimeballItemByName("dirt"), 10),
                    new ItemStack(Items.EMERALD, 1), 8, 2, 0.05f
            ));
            trades.get(1).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemCost(ModTiers.getSlimeballItemByName("stone"), 10),
                    new ItemStack(Items.EMERALD, 1), 8, 2, 0.05f
            ));
            trades.get(1).add((pTrader, pRandom) -> new MerchantOffer(
            ...
            trades.get(1).add((pTrader, pRandom) -> new MerchantOffer(
                    ...
                    new ItemStack(ModTiers.getSlimeballItemByName("copper").get(), 4), 8, 1, 0.05f
            ));
            //Apprentice
            ...
            trades.get(2).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemCost(Items.EMERALD, 1),
                    new ItemStack(ModTiers.getSlimeballItemByName("iron").get(), 4), 4, 10, 0.05f
            ));
            trades.get(2).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemCost(Items.EMERALD, 1),
                    new ItemStack(ModTiers.getSlimeballItemByName("stone").get(), 6), 4, 10, 0.05f
            ));
            //Journeyman
            trades.get(3).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemCost(ModTiers.getBucketItemByName("dirt").get(), 16),
                    new ItemStack(Items.EMERALD, 1), 4, 15, 0.05f
            ));
            trades.get(3).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemCost(ModTiers.getBucketItemByName("stone").get(), 12),
                    new ItemStack(Items.EMERALD, 1), 4, 15, 0.05f
            ));
            trades.get(3).add((pTrader, pRandom) -> new MerchantOffer(
            ...
            trades.get(4).add((pTrader, pRandom) -> new MerchantOffer(
                    ...
                    new ItemStack(ModTiers.getDnaItemByName("iron").get(), 1), 4, 20, 0.05f
            ));
            trades.get(4).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemCost(Items.EMERALD, 28),
                    new ItemStack(ModTiers.getDnaItemByName("gold").get(), 1), 4, 20, 0.05f
            ));
            trades.get(4).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemCost(Items.EMERALD, 48),
                    new ItemStack(ModTiers.getDnaItemByName("diamond").get(), 1), 4, 20, 0.05f
            ));
            //Master
            trades.get(5).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemCost(Items.EMERALD, 64),
                    new ItemStack(ModTiers.getSpawnEggItemByName("diamond").get(), 1), 2, 30, 0.05f
            ));
            trades.get(5).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemCost(Items.EMERALD, 40),
                    new ItemStack(ModTiers.getSpawnEggItemByName("gold").get(), 1), 2, 30, 0.05f
            ));
            trades.get(5).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemCost(Items.EMERALD, 48),
                    new ItemStack(ModTiers.getSpawnEggItemByName("iron").get(), 1), 2, 30, 0.05f
            ));
            trades.get(5).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemCost(Items.EMERALD, 32),
                    new ItemStack(ModTiers.getSpawnEggItemByName("copper").get(), 1), 2, 30, 0.05f
            ));
            trades.get(5).add((pTrader, pRandom) -> new MerchantOffer(
                    new ItemCost(ModTiers.getSpawnEggItemByName("dirt").get(), 1),
