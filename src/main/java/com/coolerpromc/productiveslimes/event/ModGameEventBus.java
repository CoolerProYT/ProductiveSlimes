...
public class ModGameEventBus {
    ...
    public static void onVillagerTrades(VillagerTradesEvent event) {
        if (event.getType() == ModVillagers.SCIENTIST){
            ...
            //Novice
            trades.get(1).add((level, pTrader, pRandom) -> new MerchantOffer(
            ...
            //Apprentice
            trades.get(2).add((level, pTrader, pRandom) -> new MerchantOffer(
                    new ItemCost(Items.EMERALD, 1),
            ...
            //Journeyman
            trades.get(3).add((level, pTrader, pRandom) -> new MerchantOffer(
            ...
            //Expert
            trades.get(4).add((level, pTrader, pRandom) -> new MerchantOffer(
            ...
            //Master
            trades.get(5).add((level, pTrader, pRandom) -> new MerchantOffer(
