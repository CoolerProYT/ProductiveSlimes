 ...
 */
public record ModTier(String name, int color, int mapColorId, int cooldown, String growthItemKey, String solidingOutputKey, int solidingOutputAmount, String synthesizingInputItemKey, String synthesizingInputDnaKey1, String synthesizingInputDnaKey2, float dnaOutputChance) {
