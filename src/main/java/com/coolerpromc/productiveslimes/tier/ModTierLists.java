...
public class ModTierLists {
    ...
    public static void init(){
        ...
        TIERS.put(Tier.IRON, new ModTiers("iron", 0xFF898c8a, 2, 3000, "minecraft:iron_block", "minecraft:iron_ingot", 1, "minecraft:iron_block", "productiveslimes:stone_slime_dna", "productiveslimes:coal_slime_dna", 0.6f));
        ...
        TIERS.put(Tier.OBSIDIAN, new ModTiers("obsidian", 0xFF030106, 29, 3500, "minecraft:obsidian", "minecraft:obsidian", 2, "minecraft:obsidian", "productiveslimes:netherrack_slime_dna", "productiveslimes:stone_slime_dna", 0.45f));
        ...
        TIERS.put(Tier.END_STONE, new ModTiers("end_stone", 0xFFcece8e, 2, 2000, "minecraft:end_stone", "minecraft:end_stone", 2, "minecraft:end_stone", "productiveslimes:stone_slime_dna", "productiveslimes:netherrack_slime_dna", 0.6f));
    ...
    public static void addRegisteredBlock(String name, RegistryObject<Block> block){
        registeredBlock.put(new ResourceLocation(ProductiveSlimes.MODID, name + "_slime_block"), block);
    }
    ...
    public static void addRegisteredDnaItem(String name, RegistryObject<Item> item){
        registeredDnaItem.put(new ResourceLocation(ProductiveSlimes.MODID, name + "_slime_dna"), item);
    }
    public static void addRegisteredSpawnEggItem(String name, RegistryObject<Item> item){
        registeredSpawnEggItem.put(new ResourceLocation(ProductiveSlimes.MODID, name + "_slime_spawn_egg"), item);
    }
    ...
    public static void addRegisteredBucketItem(String name, RegistryObject<Item> bucketItem){
        registeredBucketItem.put(new ResourceLocation(ProductiveSlimes.MODID, "molten_" + name + "_bucket"), bucketItem);
    }

    public static void addRegisteredSource(String name, Supplier<ForgeFlowingFluid.Source> source){
        registeredSource.put(new ResourceLocation(ProductiveSlimes.MODID, "source_molten_" + name), source);
    }

    public static void addRegisteredFlow(String name, Supplier<ForgeFlowingFluid.Flowing> flow){
        registeredFlow.put(new ResourceLocation(ProductiveSlimes.MODID, "flowing_molten_" + name), flow);
    }
    ...
    public static RegistryObject<Block> getBlockByName(String name){
        return registeredBlock.get(new ResourceLocation(ProductiveSlimes.MODID, name + "_slime_block"));
    }

    public static RegistryObject<Item> getSlimeballItemByName(String name){
        return registeredSlimeballItem.get(new ResourceLocation(ProductiveSlimes.MODID, name + "_slimeball"));
    }

    public static RegistryObject<Item> getDnaItemByName(String name){
        return registeredDnaItem.get(new ResourceLocation(ProductiveSlimes.MODID, name + "_slime_dna"));
    }

    public static RegistryObject<Item> getSpawnEggItemByName(String name){
        return registeredSpawnEggItem.get(new ResourceLocation(ProductiveSlimes.MODID, name + "_slime_spawn_egg"));
    }

    public static RegistryObject<EntityType<BaseSlime>> getEntityByName(String name){
    ...
    public static RegistryObject<Item> getBucketItemByName(String name){
        return registeredBucketItem.get(new ResourceLocation(ProductiveSlimes.MODID, "molten_" + name + "_bucket"));
    }

    public static Supplier<ForgeFlowingFluid.Source> getSourceByName(String name){
        return registeredSource.get(new ResourceLocation(ProductiveSlimes.MODID, "source_molten_" + name));
    }

    public static Supplier<ForgeFlowingFluid.Flowing> getFlowByName(String name){
