...
public class SlimeSqueezerScreen extends ContainerScreen<SlimeSqueezerMenu> {
    ...
    public SlimeSqueezerScreen(SlimeSqueezerMenu pMenu, PlayerInventory pPlayerInventory, ITextComponent pTitle) {
