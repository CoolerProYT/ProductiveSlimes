...
public class SlimeNestMenu extends Container {
    ...
    public SlimeNestMenu(int pContainerId, PlayerInventory inv, PacketBuffer extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new IntArray(6));
    }

    public SlimeNestMenu(int pContainerId, PlayerInventory inv, TileEntity entity, IIntArray data) {
    ...
    public ItemStack getDrop() {
        ...
        return SlimeData.fromTag(blockEntity.getSlime().getTag().getCompound("slime_data")).dropItem();
    }
}