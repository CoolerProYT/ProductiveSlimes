...
public class MeltingStationMenu extends Container {
    public final MeltingStationBlockEntity blockEntity;
    private final World level;
    private final IIntArray data;

    public MeltingStationMenu(int pContainerId, PlayerInventory inv, PacketBuffer extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new IntArray(4));
    }

    public MeltingStationMenu(int pContainerId, PlayerInventory inv, TileEntity entity, IIntArray data) {
