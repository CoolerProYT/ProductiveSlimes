...
public class SolidingStationMenu extends Container {
    public final SolidingStationBlockEntity blockEntity;
    private final World level;
    private final IIntArray data;

    public SolidingStationMenu(int pContainerId, PlayerInventory inv, PacketBuffer extraData) {
        this(pContainerId, inv, inv.player.level.getBlockEntity(extraData.readBlockPos()), new IntArray(4));
    }

    public SolidingStationMenu(int pContainerId, PlayerInventory inv, TileEntity entity, IIntArray data) {
