...
public class ProductiveSlimes
{
    ...
    public void onServerStarting(ServerStartingEvent event)
    {
        ...
        event.getServer().getCommands().performCommand(event.getServer().createCommandSourceStack().dispatcher().parse("reload", event.getServer().createCommandSourceStack()), "reload");
    }
