...
public class DiamondSlime extends BaseSlime{
    ...
    public void dropResource() {
        ItemEntity itemEntity = new ItemEntity(this.level(), this.getX(), this.getY(), this.getZ(), new ItemStack(ModItems.DIAMOND_SLIME_BALL.get(), this.getSize()));
    ...
    protected ParticleOptions getParticleType() {
        return new ItemParticleOption(ParticleTypes.ITEM, new ItemStack(ModItems.DIAMOND_SLIME_BALL.get()));
    }
}
