...
public class Slime extends BaseSlime {
    ...
    public Slime(EntityType<? extends net.minecraft.world.entity.monster.Slime> entityType, Level level, int cooldown, int color, RegistryObject<Item> item, ItemLike growthItem) {
