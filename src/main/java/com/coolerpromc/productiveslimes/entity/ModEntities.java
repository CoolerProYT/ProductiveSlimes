...
public class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<EndStoneSlime>> END_STONE_SLIME =
            ENTITY_TYPES.register("end_stone_slime", () -> EntityType.Builder.of(EndStoneSlime::new, MobCategory.CREATURE).build("end_stone_slime"));
