...
public class ModItems {
    ...
    public static void registerTierItem() {
        for (Tier tier : Tier.values()) {
            ...
            RegistryObject<Item> spawnEgg = ITEMS.register(spawnEggName, () -> new ForgeSpawnEggItem(ModTierLists.getEntityByName(modTiers.name()), color, color, new Item.Properties()));
