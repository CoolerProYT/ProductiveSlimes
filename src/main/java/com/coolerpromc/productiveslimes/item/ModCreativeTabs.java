    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> PRODUCTIVE_SLIMES_TAB = CREATIVE_MOD_TABS.register("productive_slimes",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(Items.SLIME_BLOCK))
                    ...
                    .displayItems(((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModItems.STONE_SLIME_DNA.get());
                        pOutput.accept(ModItems.IRON_SLIME_DNA.get());
                        pOutput.accept(ModItems.COPPER_SLIME_DNA.get());
                        pOutput.accept(ModItems.GOLD_SLIME_DNA.get());
                        pOutput.accept(ModItems.DIAMOND_SLIME_DNA.get());
                        pOutput.accept(ModItems.NETHERITE_SLIME_DNA.get());
                        pOutput.accept(ModItems.LAPIS_SLIME_DNA.get());
                        pOutput.accept(ModItems.REDSTONE_SLIME_DNA.get());
                        pOutput.accept(ModItems.OAK_SLIME_DNA.get());
                        pOutput.accept(ModItems.SAND_SLIME_DNA.get());
                        pOutput.accept(ModItems.ANDESITE_SLIME_DNA.get());
                        pOutput.accept(ModItems.SNOW_SLIME_DNA.get());
                        pOutput.accept(ModItems.ICE_SLIME_DNA.get());
                        pOutput.accept(ModItems.MUD_SLIME_DNA.get());
                        pOutput.accept(ModItems.CLAY_SLIME_DNA.get());
                        pOutput.accept(ModItems.RED_SAND_SLIME_DNA.get());
                        pOutput.accept(ModItems.MOSS_SLIME_DNA.get());
                        pOutput.accept(ModItems.DEEPSLATE_SLIME_DNA.get());
                        pOutput.accept(ModItems.GRANITE_SLIME_DNA.get());
                        pOutput.accept(ModItems.DIORITE_SLIME_DNA.get());
                        pOutput.accept(ModItems.CALCITE_SLIME_DNA.get());
                        pOutput.accept(ModItems.TUFF_SLIME_DNA.get());
                        pOutput.accept(ModItems.DRIPSTONE_SLIME_DNA.get());
                        pOutput.accept(ModItems.PRISMARINE_SLIME_DNA.get());
                        pOutput.accept(ModItems.MAGMA_SLIME_DNA.get());
                        pOutput.accept(ModItems.OBSIDIAN_SLIME_DNA.get());
                        pOutput.accept(ModItems.NETHERRACK_SLIME_DNA.get());
                        pOutput.accept(ModItems.SOUL_SAND_SLIME_DNA.get());
                        pOutput.accept(ModItems.SOUL_SOIL_SLIME_DNA.get());
                        pOutput.accept(ModItems.BLACKSTONE_SLIME_DNA.get());
                        pOutput.accept(ModItems.BASALT_SLIME_DNA.get());
                        pOutput.accept(ModItems.ENDSTONE_SLIME_DNA.get());
                        pOutput.accept(ModItems.QUARTZ_SLIME_DNA.get());
                        pOutput.accept(ModItems.GLOWSTONE_SLIME_DNA.get());
                        pOutput.accept(ModItems.AMETHYST_SLIME_DNA.get());
                        pOutput.accept(ModItems.BROWN_MUSHROOM_SLIME_DNA.get());
                        pOutput.accept(ModItems.RED_MUSHROOM_SLIME_DNA.get());
                        pOutput.accept(ModItems.CACTUS_SLIME_DNA.get());
                        pOutput.accept(ModItems.COAL_SLIME_DNA.get());
                        pOutput.accept(ModItems.GRAVEL_SLIME_DNA.get());
