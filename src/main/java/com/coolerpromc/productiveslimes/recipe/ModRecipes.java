...
public class ModRecipes{
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<MeltingRecipe>> MELTING_TYPE =
            TYPES.register("melting", () -> RecipeType.simple(Identifier.fromNamespaceAndPath(ProductiveSlimes.MODID, "melting")));
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<SolidingRecipe>> SOLIDING_TYPE =
            TYPES.register("soliding", () -> RecipeType.simple(Identifier.fromNamespaceAndPath(ProductiveSlimes.MODID, "soliding")));
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<DnaExtractingRecipe>> DNA_EXTRACTING_TYPE =
            TYPES.register("dna_extracting", () -> RecipeType.simple(Identifier.fromNamespaceAndPath(ProductiveSlimes.MODID, "dna_extracting")));
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<DnaSynthesizingRecipe>> DNA_SYNTHESIZING_TYPE =
            TYPES.register("dna_synthesizing", () -> RecipeType.simple(Identifier.fromNamespaceAndPath(ProductiveSlimes.MODID, "dna_synthesizing")));
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<SqueezingRecipe>> SQUEEZING_TYPE =
            TYPES.register("squeezing", () -> RecipeType.simple(Identifier.fromNamespaceAndPath(ProductiveSlimes.MODID, "squeezing")));
