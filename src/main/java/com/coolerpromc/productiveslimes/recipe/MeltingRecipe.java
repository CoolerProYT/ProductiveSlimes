...
public record MeltingRecipe(List<Ingredient> inputItems, List<ItemStack> output, int inputCount, int energy) implements Recipe<SingleRecipeInput>{
    @Override
    ...
    public static class Serializer implements RecipeSerializer<MeltingRecipe>{
        ...
        public final MapCodec<MeltingRecipe> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
