...
public record FluidTankProperty30k() implements ConditionalItemModelProperty {
    public static final MapCodec<FluidTankProperty30k> MAP_CODEC = MapCodec.unit(new FluidTankProperty30k());
    @Override
    public boolean get(ItemStack stack, @Nullable ClientLevel level, @Nullable LivingEntity entity, int p_388885_, ItemDisplayContext displayContext) {
        ...
        return fluidStack.getAmount() <= 30000;
    }
