...
public record FluidTankProperty33k() implements ConditionalItemModelProperty {
    public static final MapCodec<FluidTankProperty33k> MAP_CODEC = MapCodec.unit(new FluidTankProperty33k());
    @Override
    public boolean get(ItemStack stack, @Nullable ClientLevel level, @Nullable LivingEntity entity, int p_388885_, ItemDisplayContext displayContext) {
        ...
        return fluidStack.getAmount() <= 33000;
    }
