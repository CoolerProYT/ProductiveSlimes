...
public record FluidTankProperty24k() implements ConditionalItemModelProperty {
    public static final MapCodec<FluidTankProperty24k> MAP_CODEC = MapCodec.unit(new FluidTankProperty24k());
    @Override
    public boolean get(ItemStack stack, @Nullable ClientLevel level, @Nullable LivingEntity entity, int p_388885_, ItemDisplayContext displayContext) {
        ...
        return fluidStack.getAmount() <= 24000;
    }
