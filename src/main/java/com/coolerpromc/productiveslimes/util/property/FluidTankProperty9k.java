...
public record FluidTankProperty9k() implements ConditionalItemModelProperty {
    public static final MapCodec<FluidTankProperty9k> MAP_CODEC = MapCodec.unit(new FluidTankProperty9k());
    @Override
    public boolean get(ItemStack stack, @Nullable ClientLevel level, @Nullable LivingEntity entity, int p_388885_, ItemDisplayContext displayContext) {
        ...
        return fluidStack.getAmount() <= 9000;
    }
