...
public record FluidTankProperty40k() implements ConditionalItemModelProperty {
    public static final MapCodec<FluidTankProperty40k> MAP_CODEC = MapCodec.unit(new FluidTankProperty40k());
    @Override
    public boolean get(ItemStack stack, @Nullable ClientLevel level, @Nullable LivingEntity entity, int p_388885_, ItemDisplayContext displayContext) {
        ...
        return fluidStack.getAmount() <= 40000;
    }
