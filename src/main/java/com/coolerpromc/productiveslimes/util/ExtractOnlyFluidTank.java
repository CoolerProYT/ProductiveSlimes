...
public class ExtractOnlyFluidTank implements IFluidHandler, IFluidTank {
    ...
    public ExtractOnlyFluidTank(int capacity, Predicate<FluidStack> validator) {
        this.capacity = capacity;
        this.validator = validator;
    }

    public ExtractOnlyFluidTank setCapacity(int capacity) {
        this.capacity = capacity;
        return this;
    }

    public ExtractOnlyFluidTank setValidator(Predicate<FluidStack> validator) {
        if (validator != null) {
            this.validator = validator;
        }
        return this;
