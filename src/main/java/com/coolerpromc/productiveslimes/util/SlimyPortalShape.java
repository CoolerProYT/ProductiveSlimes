...
import com.coolerpromc.productiveslimes.block.custom.SlimyPortalBlock;
...
public class SlimyPortalShape {
    ...
    private static final BlockBehaviour.StatePredicate FRAME = (state, level, pos) -> state.is(ModBlocks.SLIMY_PORTAL_FRAME);
    ...
    public static Optional<SlimyPortalShape> findEmptyPortalShape(LevelAccessor level, BlockPos bottomLeft, Direction.Axis axis) {
    ...
    public static Optional<SlimyPortalShape> findPortalShape(LevelAccessor level, BlockPos bottomLeft, Predicate<SlimyPortalShape> predicate, Direction.Axis axis) {
    ...
    public static SlimyPortalShape findAnyShape(BlockGetter level, BlockPos bottomLeft, Direction.Axis axis) {
    ...
    private static int getDistanceUntilTop(
        ...
        for (int i = 0; i < 21; i++) {
            ...
            for (int j = 0; j < width; j++) {
                ...
                if (blockstate.is(ModBlocks.SLIMY_PORTAL)) {
    ...
    private static boolean isEmpty(BlockState state) {
        return state.isAir() || state.is(BlockTags.FIRE) || state.is(ModBlocks.SLIMY_PORTAL);
    }
    ...
    public void createPortalBlocks(LevelAccessor level) {
        BlockState blockstate = ModBlocks.SLIMY_PORTAL.get().defaultBlockState().setValue(SlimyPortalBlock.AXIS, this.axis);
