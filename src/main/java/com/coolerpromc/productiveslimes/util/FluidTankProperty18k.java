...
public record FluidTankProperty18k() implements ConditionalItemModelProperty {
    public static final MapCodec<FluidTankProperty18k> MAP_CODEC = MapCodec.unit(new FluidTankProperty18k());
    @Override
    public boolean get(ItemStack stack, @Nullable ClientLevel level, @Nullable LivingEntity entity, int p_388885_, ItemDisplayContext displayContext) {
        ...
        return fluidStack.getAmount() <= 18000;
    }
