...
//        iRecipeLayoutBuilder.addSlot(RecipeIngredientRole.INPUT,40,29).addItemStack(new ItemStack(meltingRecipe.getInputItems().get(0).items().get(0), meltingRecipe.getInputCount()));
