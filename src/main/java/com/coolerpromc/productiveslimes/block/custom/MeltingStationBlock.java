...
public class MeltingStationBlock extends Block {
    ...
    public ActionResultType use(BlockState pState, World pLevel, BlockPos pPos, PlayerEntity pPlayer, Hand pHand, BlockRayTraceResult pHit) {
        if (!pLevel.isClientSide()) {
            ...
            if (entity instanceof MeltingStationBlockEntity) {
                NetworkHooks.openGui(((ServerPlayerEntity)pPlayer), (MeltingStationBlockEntity)entity, pPos);
            } else {
    ...
    public void setPlacedBy(World pLevel, BlockPos pPos, BlockState pState, @Nullable LivingEntity pPlacer, ItemStack pStack) {
        ...
        if (be instanceof MeltingStationBlockEntity) {
            MeltingStationBlockEntity meltingStationBlockEntity = (MeltingStationBlockEntity) be;
