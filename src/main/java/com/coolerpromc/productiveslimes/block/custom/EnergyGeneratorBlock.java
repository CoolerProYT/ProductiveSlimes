    ...
    public ActionResultType use(BlockState pState, World pLevel, BlockPos pPos, PlayerEntity pPlayer, Hand pHand, BlockRayTraceResult pHit) {
        if (!pLevel.isClientSide()) {
            ...
            if (entity instanceof EnergyGeneratorBlockEntity) {
                EnergyGeneratorBlockEntity energyGeneratorBlockEntity = (EnergyGeneratorBlockEntity) entity;
                NetworkHooks.openGui(((ServerPlayerEntity)pPlayer), energyGeneratorBlockEntity, pPos);
            } else {
