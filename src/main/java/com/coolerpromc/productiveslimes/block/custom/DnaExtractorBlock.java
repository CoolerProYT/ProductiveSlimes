...
public class DnaExtractorBlock extends Block implements TranslucentHighlightFix {
    ...
    public ActionResultType use(BlockState pState, World pLevel, BlockPos pPos, PlayerEntity pPlayer, Hand pHand, BlockRayTraceResult pHit) {
        if (!pLevel.isClientSide()) {
            ...
            if (entity instanceof DnaExtractorBlockEntity) {
                DnaExtractorBlockEntity dnaExtractorBlockEntity = (DnaExtractorBlockEntity) entity;
                NetworkHooks.openGui(((ServerPlayerEntity)pPlayer), dnaExtractorBlockEntity, pPos);
            } else {
    ...
    public void setPlacedBy(World pLevel, BlockPos pPos, BlockState pState, @Nullable LivingEntity pPlacer, ItemStack pStack) {
        ...
        if (be instanceof DnaExtractorBlockEntity) {
            DnaExtractorBlockEntity dnaExtractorBlockEntity = (DnaExtractorBlockEntity) be;
