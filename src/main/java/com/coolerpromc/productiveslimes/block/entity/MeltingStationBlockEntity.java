...
public class MeltingStationBlockEntity extends TileEntity implements INamedContainerProvider, ITickableTileEntity {
    ...
    public MeltingStationBlockEntity() {
        super(ModBlockEntities.MELTING_STATION_BE.get());
    ...
    public ITextComponent getDisplayName() {
        return new TranslationTextComponent("block.productiveslimes.melting_station");
    }
