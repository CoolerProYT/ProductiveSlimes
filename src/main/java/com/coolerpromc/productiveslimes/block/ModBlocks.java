...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> MELTING_STATION = registerBlock("melting_station",
            () -> new MeltingStationBlock(AbstractBlock.Properties.copy(Blocks.IRON_BLOCK).noOcclusion().noDrops()));

    public static final RegistryObject<Block> LIQUID_SOLIDING_STATION = registerBlock("soliding_station",
            () -> new SolidingStationBlock(AbstractBlock.Properties.copy(Blocks.IRON_BLOCK).noOcclusion().noDrops()));

    public static final RegistryObject<Block> ENERGY_GENERATOR = registerBlock("energy_generator",
            () -> new EnergyGeneratorBlock(AbstractBlock.Properties.copy(Blocks.IRON_BLOCK).noOcclusion().noDrops()));

    public static final RegistryObject<Block> CABLE = registerBlock("cable",
            () -> new CableBlock(AbstractBlock.Properties.copy(Blocks.IRON_BLOCK).noOcclusion()));

    public static final RegistryObject<Block> DNA_EXTRACTOR = registerBlock("dna_extractor",
            () -> new DnaExtractorBlock(AbstractBlock.Properties.copy(Blocks.IRON_BLOCK).noOcclusion().noDrops()));

    public static final RegistryObject<Block> DNA_SYNTHESIZER = registerBlock("dna_synthesizer",
            () -> new DnaSynthesizerBlock(AbstractBlock.Properties.copy(Blocks.IRON_BLOCK).noOcclusion().noDrops()));

    public static final RegistryObject<Block> SLIME_SQUEEZER = registerBlock("slime_squeezer",
            () -> new SlimeSqueezerBlock(AbstractBlock.Properties.copy(Blocks.IRON_BLOCK).noOcclusion().noDrops()));
    public static final RegistryObject<Block> SQUEEZER = registerBlock("squeezer",
            () -> new SqueezerBlock(AbstractBlock.Properties.copy(Blocks.IRON_BLOCK).noOcclusion().noDrops()));

    public static final RegistryObject<Block> SLIME_NEST = registerBlock("slime_nest",
            () -> new SlimeNestBlock(AbstractBlock.Properties.copy(Blocks.IRON_BLOCK).noOcclusion()));

    public static final RegistryObject<Block> FLUID_TANK = registerBlockWithoutItem("fluid_tank",
            () -> new FluidTankBlock(AbstractBlock.Properties.copy(Blocks.IRON_BLOCK).noOcclusion().noDrops()));

    public static final RegistryObject<Block> SLIMEBALL_COLLECTOR = registerBlock("slimeball_collector",
            () -> new SlimeballCollectorBlock(AbstractBlock.Properties.copy(Blocks.IRON_BLOCK).noOcclusion()));

    public static final RegistryObject<Block> SLIMY_GRASS_BLOCK = registerBlock("slimy_grass_block",
            () -> new SlimyBlock(AbstractBlock.Properties.copy(Blocks.GRASS_BLOCK)));
    ...
    private static <T extends Block> RegistryObject<BlockItem> registerBlockItem(String name, RegistryObject<T> block){
        return ModItems.ITEMS.register(name, () -> new BlockItem(block.get(), new Item.Properties().tab(ItemGroup.TAB_BUILDING_BLOCKS)));
    }
