...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> PIPE = registerBlock("pipe", PipeBlock::new, BlockBehaviour.Properties.ofFullCopy(Blocks.IRON_BLOCK).noOcclusion().sound(SoundType.METAL));
    ...
    public static final DeferredBlock<Block> SLIMY_LEAVES = registerBlock("slimy_leaves", properties -> new ModLeavesBlock(0.0f, properties), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_LEAVES));
