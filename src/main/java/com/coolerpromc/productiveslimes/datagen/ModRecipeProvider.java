...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes() {
        ...
        for(Tier tier : Tier.values()){
            ...
            //Soliding Recipe
            solidingRecipe(output, ModTierLists.getBucketItemByName(name), ModTierLists.getItemByKey(modTiers.solidingOutputKey()), 1, modTiers.solidingOutputAmount());

            //Dna Extracting Recipe
            dnaExtractingRecipe(output, ModTierLists.getSlimeballItemByName(name), ModTierLists.getDnaItemByName(name), 1, modTiers.dnaOutputChance());

            //Dna Synthesizing Self Recipe
            dnaSynthesizingSelfRecipe(output, ModTierLists.getSpawnEggItemByName(name), 2, ModTierLists.getDnaItemByName(name), ModTierLists.getDnaItemByName(name), ModTierLists.getItemByKey(modTiers.synthesizingInputItemKey()));

            //Dna Synthesizing Recipe
            dnaSynthesizingRecipe(output, ModTierLists.getSpawnEggItemByName(name), 4, ModTierLists.getItemByKey(modTiers.synthesizingInputDnaKey1()), ModTierLists.getItemByKey(modTiers.synthesizingInputDnaKey2()), ModTierLists.getItemByKey(modTiers.synthesizingInputItemKey()));
        }
